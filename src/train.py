...
# This function builds the preprocessing pipeline dynamically using numeric and categorical feature lists from MODEL_CONFIG.
...
# This function builds the complete sklearn pipeline: preprocessing + RandomForest model.
